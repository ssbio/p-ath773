...
input1=open('/home/ssbio/wschroeder/p-athRoot/p-ath780Root.txt','r')

#these are the output file names, 'w' denotes write operation
output1=open('/home/ssbio/wschroeder/p-athRoot/metabolites.txt','w')
output2=open('/home/ssbio/wschroeder/p-athRoot/rxntype.txt','w')
output3=open('/home/ssbio/wschroeder/p-athRoot/S_matrix.txt','w')
output4=open('/home/ssbio/wschroeder/p-athRoot/reactions.txt','w')
output5=open('/home/ssbio/wschroeder/p-athRoot/exchange_reactions.txt','w')
output6=open('/home/ssbio/wschroeder/p-athRoot/irreversible_reactions_f.txt','w')
output9=open('/home/ssbio/wschroeder/p-athRoot/irreversible_reactions_b.txt','w')
output7=open('/home/ssbio/wschroeder/p-athRoot/reversible_reactions_no_exchange.txt','w')
output8=open('/home/ssbio/wschroeder/p-athRoot/regulated_reactions.txt','w')
