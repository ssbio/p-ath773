...
input1=open('/home/ssbio/wschroeder/p-athLeaf/p-ath780Leaf.txt','r')

#these are the output file names, 'w' denotes write operation
output1=open('/home/ssbio/wschroeder/p-athLeaf/metabolites.txt','w')
output2=open('/home/ssbio/wschroeder/p-athLeaf/rxntype.txt','w')
output3=open('/home/ssbio/wschroeder/p-athLeaf/S_matrix.txt','w')
output4=open('/home/ssbio/wschroeder/p-athLeaf/reactions.txt','w')
output5=open('/home/ssbio/wschroeder/p-athLeaf/exchange_reactions.txt','w')
output6=open('/home/ssbio/wschroeder/p-athLeaf/irreversible_reactions_f.txt','w')
output9=open('/home/ssbio/wschroeder/p-athLeaf/irreversible_reactions_b.txt','w')
output7=open('/home/ssbio/wschroeder/p-athLeaf/reversible_reactions_no_exchange.txt','w')
output8=open('/home/ssbio/wschroeder/p-athLeaf/regulated_reactions.txt','w')
