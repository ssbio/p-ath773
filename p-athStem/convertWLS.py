...
input1=open('/home/ssbio/wschroeder/p-athStem/p-ath780Stem.txt','r')

#these are the output file names, 'w' denotes write operation
output1=open('/home/ssbio/wschroeder/p-athStem/metabolites.txt','w')
output2=open('/home/ssbio/wschroeder/p-athStem/rxntype.txt','w')
output3=open('/home/ssbio/wschroeder/p-athStem/S_matrix.txt','w')
output4=open('/home/ssbio/wschroeder/p-athStem/reactions.txt','w')
output5=open('/home/ssbio/wschroeder/p-athStem/exchange_reactions.txt','w')
output6=open('/home/ssbio/wschroeder/p-athStem/irreversible_reactions_f.txt','w')
output9=open('/home/ssbio/wschroeder/p-athStem/irreversible_reactions_b.txt','w')
output7=open('/home/ssbio/wschroeder/p-athStem/reversible_reactions_no_exchange.txt','w')
output8=open('/home/ssbio/wschroeder/p-athStem/regulated_reactions.txt','w')
